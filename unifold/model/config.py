...
def model_config(
    ...
    """Get the ConfigDict of a Uni-Fold model."""
...
CONFIG_DIFFS = {
    ...
    'unifold': {
        ...
        'data.eval.crop_size': 192,
        'model.embeddings_and_evoformer.evoformer_num_block': 16,
    ...
    # Below are configurations of finetuning AlphaFold models, unaltered.
    'model_1': {
