...
from unifold.model.tf import shape_helpers
from unifold.model.tf import shape_placeholders
from unifold.model.tf import utils
import numpy as np
...
def curry1(f):
    ...
    # ziyao:  if you have a function: f(x, opt1, opt2, ...) decorated with curry1,
    #         you shall use it as f(opt1, opt2, ...)(x).
    def fc(*args, **kwargs):
