...
FEATNAME_DICT = set(['aatype', 'residue_index', 'seq_length', 'template_aatype', 'template_all_atom_masks',
                     'template_all_atom_positions', 'template_sum_probs', 'is_distillation', 'seq_mask', 'msa_mask',
                     'msa_row_mask', 'random_crop_to_size_seed', 'template_mask', 'template_pseudo_beta',
                     'template_pseudo_beta_mask', 'atom14_atom_exists', 'residx_atom14_to_atom37',
                     'residx_atom37_to_atom14', 'atom37_atom_exists', 'extra_msa', 'extra_msa_mask',
                     'extra_msa_row_mask', 'bert_mask', 'true_msa', 'extra_has_deletion', 'extra_deletion_value',
...
class DataSystem:
    ...
    def load(self, prot_name: str):
        ...
        raw_labels = utils.load_labels(
            ...
            fasta_dir=os.path.join(self.dc.mmcif_dir.rsplit("/", 2)[0], "fasta"),
            pdb_id=pdb_id,
            chain_id=chain_id)
    ...
    def get_batch(
        ...
        # HJ: for training
        done_features = "/home/hanj/workplace/unifold_dataset/training_set/features_unifold_256/" + prot_name + ".pkl"
